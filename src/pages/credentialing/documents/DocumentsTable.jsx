...
import { getCredentialDocuments } from "../../../api_request";
  ...
  const getDocuments = async (
    ...
    try {
      const data = {
        ...
        has_expire: filterData?.has_expire === "yes" ? 1 : "0" || "",
        is_required: filterData?.is_required === "yes" ? 1 : "0" || "",
