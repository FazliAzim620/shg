...
const ServiceProviderSettingsTab_BasicInfo = ({ admin, provider_id }) => {
  ...
  const { statesList, providerRolesList, medicalSpecialities, jobsTableData } =
  ...
  const getUserData = async () => {
    try {
      const resp = await API.get(
        `/api/get-user-detail?provider_id=${provider_id}`
      );
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={12} md={9} sx={{}}>
              <MultipleSelectCheckmarks
                ...
                value={formData.provider_specialities} // Pass the current specialities
...
export default ServiceProviderSettingsTab_BasicInfo;
