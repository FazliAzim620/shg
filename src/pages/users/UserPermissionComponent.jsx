...
import { CustomSwitch } from "../../components/userManagementcomponents/CustomSwitch";
...
import { DeleteConfirmModal as ConfirmationModal } from "../../components/handleConfirmDelete";
...
const UserPermissionComponent = ({
  ...
  const [changeTextAllow, setChangeTextAllow] = useState(false);
  ...
  const renderPermissions = (module) => {
    ...
    const sectionsToRender = !userEdit ? activeSections : sectionKeys;
          ...
          bodyText={
            <Box>
              ...
              >
                {userEdit?.user
                  ? changeTextAllow === "Remove All"
                    ? `Are you sure you want to remove all permissions from the user for the selected module? This action will revoke their full access and permissions.`
      ...
      <ConfirmationModal
        ...
        bodyText={
          <Box>
            ...
            >
              {pendingSwitch?.event
                ? ` Granting permissions will allow ${
                    userEdit?.user?.name ? userEdit?.user?.name : ""
                  } to access resources/actions within the selected module.`
                : userEdit?.user
                ? ` Removing permissions will prevent ${
                    userEdit?.user?.name ? userEdit?.user?.name : ""
                  } from accessing resources/actions within the selected module`
                : ` Updating this user's role will replace their current permissions
                with those of the new role. All existing permissions will be
                removed. Are you sure you want to proceed?`}
            </Typography>
                        ...
                        >
                          ...
                          {userEdit ? (
                            <CustomSwitch
                              ...
                              disabled={!userEdit}
                              onChange={(e) =>
                                handleModuleSwitchChangeWithConfirmation(
                                  module,
                                  e
                                )
                              }
