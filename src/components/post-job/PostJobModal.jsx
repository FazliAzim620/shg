...
export default function PostJobModal({ open, handleClose, editLocation }) {
  ...
  return (
    ...
    >
      <Box sx={style}>
        ...
        <PostJobStepper handleClose={handleClose} editLocation={editLocation} />
      </Box>
    </Modal>
  );
}
