...
const ClientSiteAddressDetailsUpdated = () => {
  ...
  const [formData, setFormData] = useState(
    currentClient?.addresses?.find(
      (current) => current?.type === "site" && current?.country !== null
    ) === undefined
      ? currentClient?.addresses?.find(
          (current) =>
            current?.type === "billing" && current?.site_same_as_billing === 1
        )
      : currentClient?.addresses?.find(
          (current) => current?.type === "site" && current?.country !== null
        )
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      form.append("data_type", "site_address");
        ...
        <Box>
          <TextField
            ...
            sx={{
              ...
              //   bgcolor: isLightMode ? "#FFF6F6" : "#3A2929",
              // },
              input: {
                color: isLightMode ? "black" : "white",
              },
...
export default ClientSiteAddressDetailsUpdated;
