...
const AssignmentLetters = () => {
  ...
  const [items, setItems] = useState([
    { text: "Assignment Letters", href: "/provider-assignment-letters" },
  ]);
  ...
  const displayHandler = async (client) => {
    ...
    setSelectedClient(client?.file_name);
    setItems([
      { text: "Assignment Letters", href: "/provider-assignment-letters" },
      { text: client?.name },
    ]);
  ...
  // const items = [
  //   { text: "Assignment Letters", href: "/" },
  //   { text: selectedClient, href: "/" },
  //   // {
  //   //   text: `${"Assignment Letters"}`,
  //   //   href: `${PROVIDER_ROUTES.timeSheet}/${12}`,
  //   // },
  // ];
  useEffect(() => {
    getClients();
              ...
              <Link
                ...
                onClick={() =>
                  setItems([
                    {
                      text: "Assignment Letters",
                      href: "/provider-assignment-letters",
                    },
                  ])
                }
                to={item.href}
          ...
          {initialclient == 0 ? (
            ...
            <Box
              sx={{
                display: "flex",
                justifyContent:
                  attachments?.length > 2 ? "start" : "space-between",
                gap: 2,
              }}
            >
