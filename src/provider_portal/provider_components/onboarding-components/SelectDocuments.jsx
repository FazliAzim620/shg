...
const SelectDocuments = ({ docData, getTabProgressInfo }) => {
  ...
  //       value: "documents",
  //       count: `${
  //         selectedDocuments.filter((d) =>
  //           tabData?.documents?.some(
  //             (td) => td?.id === d?.id && td?.class === d?.class
  //           )
  //         )?.length
  ...
  //       value: "organizationDocs",
  //       count: `${
  //         selectedDocuments?.filter((d) =>
  //           tabData?.organizationDocs?.some(
  //             (td) => td?.id === d?.id && td?.class === d?.class
  //           )
  //         )?.length
  //       }/${tabData?.organizationDocs?.length}`,
  //     },
  //     {
  //       label: "Reference forms",
  //       value: "referenceForms",
  //       count: `${
  //         selectedDocuments?.filter((d) =>
  //           tabData?.referenceForms?.some(
  //             (td) => td?.id === d?.id && td?.class === d?.class
  //           )
  //         )?.length
  //       }/${tabData?.referenceForms.length}`,
  //     },
  //     {
  //       label: "Forms",
  //       value: "forms",
  ...
  //           )
  //         )?.length
  //       }/${tabData?.forms?.length}`,
  //     },
  //     {
  //       label: "Professional registration",
  //       value: "professionalRegistration",
  //       count:
  //         tabData?.professionalRegistration?.length === 0
  //           ? "0/0"
  //           : `${
  //               selectedDocuments?.filter((d) =>
  //                 tabData?.professionalRegistration?.some(
  //                   (td) => td?.id === d?.id && td?.class === d?.class
  //                 )
  //               )?.length
  //             }/${tabData?.professionalRegistration?.length}`,
  //     },
  //     {
  //       label: "Background checks",
  //       value: "backgroundChecks",
  //       count:
  //         tabData?.backgroundChecks?.length === 0
  //           ? "0/0"
  //           : `${
  //               selectedDocuments?.filter((d) =>
  //                 tabData?.backgroundChecks?.some(
  //                   (td) => td?.id === d?.id && td?.class === d?.class
  //                 )
  //               )?.length
  //             }/${tabData?.backgroundChecks?.length}`,
  //     },
  //   ];

  //   return tabs.filter((tab) => tab.count !== "0/0");
  // };
